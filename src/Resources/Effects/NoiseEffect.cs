...
namespace ApplManga.Resources.Effects {
    public class NoiseEffect : ShaderEffect {
        ...
        public NoiseEffect() {
            ...
            pixelShader.UriSource = new Uri("/ApplManga;component/Resources/Effects/Noise.ps", UriKind.Relative);
            PixelShader = pixelShader;

            BitmapImage bitmap = new BitmapImage();
            bitmap.BeginInit();
            bitmap.UriSource = new Uri("pack://application:,,,/ApplManga;component/Resources/Images/noise.png");
            bitmap.EndInit();
