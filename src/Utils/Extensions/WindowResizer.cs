...
namespace ApplManga.Utils.Extensions {
    ...
    public class WindowResizer {
        ...
        private IntPtr WindowProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled) {
            switch (msg) {
                ...
                case 0x0024: /* WM_GETMINMAXINFO */
                    ...
                    // Let the default WPF mechanism handle the minimum window size
                    handled = false;
                    break;
            }
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam) {
            ...
            // TODO: Fix window not sized properly when maximized on 125% scaling
            // (only when taskbar is at the default position, other positions work just fine)
